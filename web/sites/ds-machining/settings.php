...
} elseif (file_exists('/home/ubuntu/shared-folders/config/ds-composites/dsm-settings.local.php')) {
  include '/home/ubuntu/shared-folders/config/ds-composites/dsm-settings.local.php';
}
/**
 * EOF
 */
