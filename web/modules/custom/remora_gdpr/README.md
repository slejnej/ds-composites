...
|----------------------------------------|-----------------------------------------------------------------|----------------------------------|
| `$cookie_bg`                           | Background colour for cookie banner                             | $global-color-light-light-100    |
...
| `$cookie_modal_radius`                 | Border radius for 'Cookie settings' modal popup                 | $global-border-border-radius-sm  |
...
| `$cookie_modal_toggle_disabled_bg`     | Background color of disabled toggle                             | $global-color-black-black-100    |
