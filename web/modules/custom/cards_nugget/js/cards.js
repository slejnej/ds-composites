    ...
    attach: function (context) {
      ...
      $(document).on('shown.bs.tab', function (event) {
        ...
        if ($(this).find('.slick-track').width() === 0) {
          ...
          $(this).find('.slick-cards .slick-initialized').slick('refresh')
        }
      })

      // SLICK
      $('.slick-cards').not('.slick-initialized').each(function () {
        const elem = $(this);
        ...
        elem.slick({
          appendDots: $(this).parent().find(".slide-cards-dots"),
          prevArrow: $(this).parent().find(".slide-cards-prev"),
          nextArrow: $(this).parent().find(".slide-cards-next"),
        });
      });
      ...
      function updateDots(e, elem) {
        ...
        const allDots = elem.find('.slick-cards-dots li');
